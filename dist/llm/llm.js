...
exports.createAgent = exports.createLlmresponse = void 0;
const client_1 = require("../utils/client");
const createLlmresponse = async () => {
    const llm = await client_1.retellClient.llm.create({
...
exports.createLlmresponse = createLlmresponse;
const createAgent = async () => {
    ...
    // })
    const agent = await client_1.retellClient.agent.create({
        voice_id: "11labs-Anthony",
        agent_name: "Anthony",
        llm_websocket_url: "",
    });
